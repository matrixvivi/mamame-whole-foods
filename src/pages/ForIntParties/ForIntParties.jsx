    ...
    return (
        <section id="for-interested">
            <div className="bottom-ctn">
                ...
                <br/><br/>For enquiries please drop us an email: info@mamame.com.<br/> In your email, please do your best to include as much details as possible on items such as:
